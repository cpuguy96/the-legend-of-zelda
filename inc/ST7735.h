...
// LCD functions added to game graphics 
void LCD_OutDec(uint32_t data);  // Draws numbers to the LCD
void SpriteDraw (int16_t x, int16_t y, const uint16_t *image, int16_t w, int16_t h); // Draws a masked image to screen
